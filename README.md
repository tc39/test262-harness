...
| `--conditional` | Use a conditional list tests to be filtered for execution. The parameter should provide a text file with a list of files and/or folders, separated by lines. Any file with a matching in this list will be flagged as a failure. | No | n/a 
